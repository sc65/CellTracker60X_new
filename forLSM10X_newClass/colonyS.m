classdef colonyS
    ...
    methods
        ...
        function object = calculateRadialProfile(object, meta, bins, colonyMask, nuclearMask)
            ...
            if ~isempty(find(colonyMask, 1)) % for regular dishes some images are empty
                ...
                % 2) get nuclear/non-nuclear/membrane intensity profiles
                intensityProfile = getColonyNuclearIntensityProfile(images, nuclearMask, meta);
                nonNuclearChannel = find(ismember(meta.channelLabel, 'non_nuclear'), 1);
                ...
                dapiChannel = cell2mat(cellfun(@(c)strcmp(c,'DAPI'),upper(meta.channelNames),'UniformOutput',false));
                ...
                membraneChannel = find(ismember(meta.channelLabel, 'non-membrane'), 1);
            ...
            % nuclear channels
            nuclearChannels = find(ismember(meta.channelLabel, 'nuclear'));
