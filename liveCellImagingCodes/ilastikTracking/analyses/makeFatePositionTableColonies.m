function fatePositionTable = makeFatePositionTableColonies(outputFilesPath, colonyIds)
...
%[T/Venus, cdx2/venus distanceFromEdgeTEnd distanceFromEdgeT0 xEnd yEnd xStart yStart colonyPartId cellId]


fatePositionTable = zeros(1000,10);
counter = 1;
for ii = colonyIds
    for jj = 1:2
        ...
        %remove cells for which Brachyury expression is non-verifiable.
        ...
        fatePositionTable(counter:counter+ncells-1, [1:3 5:6 9:10]) = [brachyury cdx2 d2' x2' y2' ...
            repmat(jj, numel(counter:counter+ncells-1), 1),trackedCellsId];
