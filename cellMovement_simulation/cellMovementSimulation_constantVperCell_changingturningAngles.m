function cellMovementSimulation_constantVperCell_changingturningAngles(outputFile1, outputFile2, nCells)
...
%% ---------- algorithm
% 1) pick nCells inside a circle of a given radius
...
for ii = 1:nCells
    ...
    allSpeed = speed(:);
    allSpeed(allSpeed>10) = []; % pick speeds <=10um (rest correspond to cell division)

    d1 = allSpeed(randi(numel(allSpeed),1)); % speed of cell remains constant
