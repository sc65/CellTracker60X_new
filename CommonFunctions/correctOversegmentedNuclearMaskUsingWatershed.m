...
function nuclear_mask = correctOversegmentedNuclearMaskUsingWatershed(mask, dapi_image)
%% -----uses watershed to correct for over segmented masks.


size = 3; %dilation radius - choose a value that ensures cell-cell separation
