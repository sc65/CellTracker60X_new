function matCatREF = overlayImage2onImage1 (image1, image2)
%% example: to overlaying fluorescent channel image (image2) on dapi (image1).


%%
matCatREF = cat(3,image1+image2,image1,image1);
%%
...
matCatREF = cat(3,imgDAPIref+imgLblREF,imgDAPIref,imgDAPIref);
%%
figure; imshow(matCatREF);